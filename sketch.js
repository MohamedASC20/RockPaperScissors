let rockLeft, paperLeft, scissorsLeft, rockRight, paperRight, scissorsRight,compScore,youScore;
...
function mouseClicked(){
    ...
    noStroke()
       ...
       if (stage == 'rock' && computerChoice == 'paper') {
        fill(128,128,128)
        rect (650,150,1000,50)
           scoreComputer++;
               compScore = 'COMPUTER: ' + scoreComputer
       }
       else if (stage == 'rock' && computerChoice == 'scissors') {
        fill(128,128,128)
        rect (650,100,1000,50)
           scoreYou++;
           youScore = 'YOU: ' + scoreYou
       }
       ...
       fill(255,0,0)
       textSize(32);
       text(youScore, 650, 150)
       text(compScore, 650, 200)
